...
| -------------------- | ----------- | ------------------------------------------------ |
| `name`               | `str`       | Display name of the playlist.                    |
| `can_delete`         | `bool`      | Whether the user can delete the playlist.        |
...
```python
LibraryPlaylistFolder(name: str, date_added: str | None = None, children: list[LibraryPlaylistFolderChild] | None = None)
```
